...
def get_args_parser():
    ...
    parser.add_argument('--invariance_coef', default=1, type=float,
                        help="invariance_equivariance_coef box coefficient in the matching cost")
    parser.add_argument('--equivariance_coef', default=1, type=float,
                        help="invariance_equivariance_coef box coefficient in the matching cost")
    ...
    parser.add_argument('--data_root', default='/home/gamir/DER-Roei/datasets')
    ...
    parser.add_argument('--invariance_equivariance', default=False, action='store_true',
                        help='whether to use this loss')
    parser.add_argument('--invariance_equivariance_loss', default='l1')
    ...
    parser.add_argument('--imagenet_path', type=str, default="/home/gamir/datasets/ilsvrc", help="path to the ImageNet dataset, like ImageNet")
